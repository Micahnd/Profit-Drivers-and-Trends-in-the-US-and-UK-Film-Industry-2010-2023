...
```
- **Data Visualization and Exploration:** I Created various charts and visualizations in Power BI to identify patterns and trends, I also explored relationships between variables, including net profit and other factors.
...
## Metrics Definition
  ...
  - Average(AVG) Rating: A measure of the average of total rating by count of ratings per movie.
## Key Findings
